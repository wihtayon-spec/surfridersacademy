...
export const products: Product[] = [
  {
    ...
    unit: "per person",
    duration: "90 minutes",
    forWho: "First-timers who want full coach attention",
    includes: ["1-on-1 coaching", "Surfboard & wetsuit", "Ocean safety briefing", "Pop-up technique"],
    featured: true,
    badge: "Most Popular",
    note: "+$5 service fee for electronic payment",
  },
  {
    id: "group",
    ...
    unit: "per person",
    duration: "90 minutes",
    forWho: "Friends and travelers learning together",
    includes: ["Small groups (max 4)", "Surfboard & wetsuit", "Ocean safety briefing", "Shared stoke"],
  },
  {
    id: "kids-family",
    name: "Kids & Family Lesson",
    price: 129,
    unit: "per person",
    duration: "90 minutes",
    forWho: "Families and kids ages 5+",
    includes: ["Patient, kid-friendly coaches", "Right-sized soft boards", "Extra water safety", "Parent-friendly pacing"],
  },
  {
    id: "pkg-3",
    name: "3-Lesson Progression Package",
    price: 399,
    unit: "3 lessons",
    duration: "90 min each",
    forWho: "Committed beginners building real skills",
    includes: ["Structured progression plan", "Same coach continuity", "Gear included every session", "Save vs. single lessons"],
    badge: "Best Value",
  },
  {
    id: "pkg-5",
    name: "5-Lesson Progression Package",
    price: 625,
    unit: "5 lessons",
    duration: "90 min each",
    forWho: "Surfers who want to ride green waves solo",
    includes: ["Full progression to independence", "Same coach continuity", "Gear included every session", "Best per-lesson price"],
  },
  {
    id: "vip",
    name: "VIP Surf Morning",
    price: 349,
    unit: "per person",
    duration: "Half day",
    forWho: "A premium, unhurried private experience",
    includes: ["Private dawn/AM session", "Top-tier gear", "Photo/video capture", "Post-surf refreshments"],
    featured: true,
    badge: "Premium",
  },
  {
    id: "gopro",
    name: "GoPro / Photo Add-On",
    price: 49,
    unit: "add-on",
    duration: "Per session",
    forWho: "Anyone who wants to keep the memory",
    includes: ["Coach captures your waves", "Edited photo/clip delivery", "Shareable highlights"],
  },
  {
    id: "corporate",
    ...
    includes: ["Fully coordinated logistics", "Multiple coaches", "Custom group sizing", "Optional catering & photos"],
    badge: "Custom",
  },
];
...
export const lessonCards = [
  ...
  },
  {
    ...
    forWho: "Families and kids ages 5+",
    blurb: "Patient coaches, right-sized boards, and extra water safety for your whole crew.",
    productId: "kids-family",
  },
  {
    id: "vip",
    title: "Premium Surf Experience",
    forWho: "Those who want the very best",
    blurb: "A private, unhurried VIP morning with top gear, photos, and post-surf refreshments.",
    productId: "vip",
  },
] as const;
...
export const faqs = [
  ...
  { q: "How long is the lesson?", a: "Standard lessons run about 90 minutes, including the on-sand safety briefing and pop-up practice. VIP and package sessions vary — see pricing for details." },
